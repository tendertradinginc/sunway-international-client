    ...
    <div className="mt-16 min-h-screen">
      <PageBanner
        ...
        description={
          <>
            {" "}
            <Breadcrumb className="mt-5 flex justify-center">
              <BreadcrumbList>
                <BreadcrumbItem>
        ...
        <Card className="rounded-none border-none shadow-none">
          <CardContent>
            <div className="my-10 grid grid-cols-1 p-0 lg:grid-cols-2">
              ...
              <section className="m-0 flex h-full flex-1 flex-col lg:px-5">
                <h2 className="text-2xl font-bold lg:text-3xl">
                  {product?.productName}
                </h2>

                <div className="mt-8 grid flex-grow break-all text-foreground">
