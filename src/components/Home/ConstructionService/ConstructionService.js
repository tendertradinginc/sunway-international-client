    ...
    <MaxWidthWrapper className="overflow-x-hidden py-16">
      ...
      <div className="mt-10 grid grid-cols-12 grid-rows-12 gap-y-10 md:gap-10">
        <motion.div
          ...
          className="col-span-12 row-span-12 bg-[url('https://i.ibb.co/QCLLvyN/pexels-shvetsa-3844581-1.jpg')] bg-cover md:col-span-6 md:row-span-12"
        >
          <div className="flex h-full w-full flex-col gap-y-2 bg-[#1c475968] pl-8 text-white">
        ...
        <motion.div
          ...
          className="col-span-12 row-span-12 bg-[url('https://i.ibb.co/tQRVJbH/pexels-pixabay-263402.jpg')] bg-cover bg-center md:col-span-6 md:row-span-5"
        >
        ...
        <motion.div
          ...
          className="col-span-12 row-span-12 bg-[url('https://i.ibb.co/LdBMqkM/pexels-tim.jpg')] bg-cover bg-center md:col-span-6 md:row-span-7"
        >
          <div className="flex h-full w-full flex-col items-center justify-center gap-y-2 bg-[#fbbe2496] p-5 pl-8 text-white">
            <Image
