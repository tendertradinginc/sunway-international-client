  ...
  return (
    ...
    >
      <div className="bg-[#0c0d0df6]">
        <MaxWidthWrapper>
          <div className="flex justify-between lg:flex-row flex-col gap-x-10 py-10">
            {/* First Column */}
            ...
            {/* Socials */}
            <ul className="flex flex-col gap-y-3">
              <li className="text-2xl font-bold text-gray-300">Live Location</li>
              <li>
                <iframe
              ...
              <li className="text-xl font-bold mt-2 text-gray-300">Socials</li>
